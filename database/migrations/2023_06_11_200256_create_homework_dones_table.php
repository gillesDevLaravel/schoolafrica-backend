...
class CreateHomeworkDonesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('homework_dones', function (Blueprint $table) {
            $table->id();
            ...
            // Disabled: historical FK constraints are applied inconsistently and break fresh migrations.
            // $table->foreign('idHomework')->references('id')->on('homework')->onDelete('restrict')->onUpdate('restrict');
            // Disabled: historical FK constraints are applied inconsistently and break fresh migrations.
    ...
    {
        Schema::dropIfExists('homework_dones');
    }
}
