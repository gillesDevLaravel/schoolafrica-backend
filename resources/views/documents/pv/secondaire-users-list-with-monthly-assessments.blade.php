...
{{--            <span class="s2 verticalAlign">{{ strtoupper(__('bulletin_primaire.rank')) }}</span>--}}
    ...
    <tr style="">
        ...
        @php $totalClasseCoef = 0; @endphp
        @foreach($assessments as $assess)
            @php $totalClasseCoef+= $assess['coefficient']; @endphp
        ...
        @endforeach
        <td style="width: 10pt; border: 1pt solid #212628; vertical-align: middle;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">
                {{ $totalClasseCoef }}
            </p>
        </td>
        <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;"></p>
        </td>
        <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;"></p>
        </td>
    ...
    <tr style="">
        ...
        @php $total_note_max_coef = 0; @endphp
        @foreach($assessments as $key => $assessment)
            @php $total_note_max_coef += $assessment['notemax'] * $assessment['coefficient'] @endphp
            <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">
                    {{ $assessment['notemax'] }}
                </p>
        ...
        <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">
                {{ $total_note_max." | ".$total_note_max_coef }}
            </p>
        </td>
        <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
...
{{--                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; margin-left: 5pt;font-size: 12px">{{ implode(' ', $firstTwoWords) }}</p>--}}
            ...
            @foreach($student->trimestre[0]->assessmentType[0]->matterGroup as $matterGroup)
                @foreach ($matterGroup->assessment as $assessment)
                    @php
                        $note = @$assessment->ratings->value;
                        $noteCoef = @$assessment->ratings->noteCoef;
                        $appreciation = getAppreciationGradeAndColor($note, $assessment->notemax); @endphp
...
{{--                            {{ $note ?? "-" }} |--}}
            ...
            <td style="width: 40pt; border: 1pt solid #212628; vertical-align: middle;">
                @php $appreciation = getAppreciationGradeAndColor($student->trimestre[0]->assessmentType[0]->moyenne, 20); @endphp
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">
                    <span style="font-weight: bold">{{ $student->trimestre[0]->assessmentType[0]->totalSequence." | ".$student->trimestre[0]->assessmentType[0]->totalSequenceNoteCoef }}</span>
                </p>
            </td>
            <td style="border: 1pt solid #212628; vertical-align: middle;">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0; color: #{{$legend_of_grade[$appreciation[1]]}}">
                    {{ $student->trimestre[0]->assessmentType[0]->moyenne }}
                </p>
            </td>
            <td style="border: 1pt solid #212628; vertical-align: middle;">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">
                    {{ $student->trimestre[0]->assessmentType[0]->rang }}
                </p>
            </td>
            <td style="border: 1pt solid #212628; vertical-align: middle;">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0; color: #{{$legend_of_grade[$appreciation[1]]}}">
            ...
            <td style="border: 1pt solid #212628; vertical-align: middle;">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0; @if($student->trimestre[0]->assessmentType[0]->moyenne<10) color:red;@endif">
                    @php
                     if($student->trimestre[0]->assessmentType[0]->moyenne >= 10) echo mb_substr(strtoupper(__('bulletin_primaire.PASSED')), 0, 1);
