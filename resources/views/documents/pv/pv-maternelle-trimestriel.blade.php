...
<table id="listStudents" style="border-collapse: collapse; margin-top: 20pt;  width: 100%" cellspacing="0">
    <tr>
        ...
        @endforeach
        <td class="" style="width:15pt; border: 1pt solid #212628; vertical-align: middle; text-align: center; margin : 0px">
...
{{--            <span class="s2 verticalAlign">{{ strtoupper(__('bulletin_primaire.rank')) }}</span>--}}
        ...
        <td colspan="2" class="" style="border: 1pt solid #212628; vertical-align: middle; text-align: center">
    ...
    <tr style="">
        ...
        @foreach($code_matieres as $code_matiere)
            <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">
                    {{ round(($code_matiere->notemax * 4) / $code_matiere->notemax) }}
                </p>
            </td>
        @endforeach
        {{--    TOTAL    --}}
        <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">
                {{ round(array_sum(array_map(function($m) { return ($m->notemax * 4) / $m->notemax; }, $code_matieres))) }}
            </p>
        </td>
        {{--    TOTAL    --}}
        <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0;">/4</p>
        </td>
        <td style="width: 5pt; border: 1pt solid #212628; vertical-align: middle;">
        ...
        <tr>
            ...
            @foreach ($code_matieres as $matiere)
                ...
                @php
                    if(isset($details_valuation->{$idEleve}->{$matiere->id})){
                        $appreciation = getAppreciationGradeAndColor($details_valuation->{$idEleve}->{$matiere->id}->noteObt, $details_valuation->{$idEleve}->{$matiere->id}->noteMaxEval, true);
                    }else {
                ...
                <td style="border: 1pt solid #212628; vertical-align: middle;">
                    <p class="s2" style="font-weight: bold; padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0; color: #{{$legend_of_grade[$appreciation[1]]}}">
                        @php
                            // Vérification si la note existe et s'il y a des évaluations.
                            if (isset($details_valuation->{$idEleve}->{$matiere->id}->noteObt) && $details_valuation->{$idEleve}->{$matiere->id}->nbrEval > 0 && $details_valuation->{$idEleve}->{$matiere->id}->noteMaxEval != null) {
                                // Calcul et incrémentation de la note totale.
                                $totalNote += round((($details_valuation->{$idEleve}->{$matiere->id}->noteObt * 4) / $details_valuation->{$idEleve}->{$matiere->id}->noteMaxEval), 2);
                                $totalNoteMax += 4;
                                // Affichage de la note calculée
                                echo number_format_if_float((($details_valuation->{$idEleve}->{$matiere->id}->noteObt * 4) / $details_valuation->{$idEleve}->{$matiere->id}->noteMaxEval), 2);;
                            } else {
                                echo "-"; // Affiche un tiret si aucune note n'est disponible.
                            }
                        @endphp
                    </p>
                </td>
            ...
            <td style="width: 40pt; border: 1pt solid #212628; vertical-align: middle;">
                @php
                    ...
                    $appreciation = getAppreciationGradeAndColor($moyenne, 20, true);

                    $moyenneSur4 = ($moyenne * 4) / 20;

                    $appreciationImage = getAppreciationStickerForMaternelle($moyenneSur4, true);
...
//                        ? number_format($details_valuation->{$idEleve}->noteObt / $details_valuation->{$idEleve}->nbrSeqEval,2)  //Note non ramenée sur 4
                        ? round($totalNote, 2)
                        : "-"
                    }}
                </span>
            ...
            <td style="border: 1pt solid #212628; vertical-align: middle;">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center; font-size: 12px; margin: 0; font-weight: bold; color: #{{$legend_of_grade[$appreciation[1]]}};">
                    <!-- Moyenne -->
                    {{ ($details_valuation->{$idEleve}->isEvalue) ? number_format_if_float($moyenneSur4) : '-'}}
                </p>
            </td>
            <td style="border: 1pt solid #212628; vertical-align: middle;">
            ...
            <td style="border: 1pt solid #212628; vertical-align: middle;" colspan="2">
...
{{--                    {{ ($details_valuation->{$idEleve}->isEvalue) ? $appreciation[0] : "-"}}--}}
                    <img style="text-align: center; width: 20px; height: 20px; padding: 2px" src="data:image/png;base64,{{ @base64_encode(file_get_contents(public_path("/public/profil/$appreciationImage"))) }}">
...
<table width="100%" style="border-collapse: collapse; margin-left: 0; margin-top: 10px; page-break-inside: avoid;">
    <tr>
        <td rowspan="2" style="width: 10%;border-top-style: solid; vertical-align: middle; border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;" >
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center;">
                <b>{{ __('bulletin_primaire.leg_of_grade') }}</b>
            </p>
        </td>
        <td style="width: 20%;border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: none;border-bottom-color: #808080;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['nye_color']}}">
                ({{__('bulletin_primaire.appr_nye')}}) {{ __('bulletin_primaire.appr_nye_txt') }} : [0;1.5[
                <br> {{$legend_of_grade['nye'] . " " . __('bulletin_primaire.leaners')}}
                <br/>
            </p>
        </td>
        <td style="width: 20%;border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: none;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['ae_color']}}">
                ({{__('bulletin_primaire.appr_ae')}}) {{ __('bulletin_primaire.appr_ae_txt') }} : [1.5;2.5[
        ...
        <td style="width: 20%;border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: none;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['me_color']}}">
                ({{__('bulletin_primaire.appr_me')}}) {{ __('bulletin_primaire.appr_me_txt') }} : [2.5;3.5[
        ...
        <td style="width: 20%;border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: none;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['abe_color']}}">
                ({{__('bulletin_primaire.appr_abe')}}) {{ __('bulletin_primaire.appr_abe_txt') }} : [3.5;4]
    ...
    <tr>
        <td style="width: 20%;border-top-style: none;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['nye_color']}}">
                <img style="display: block; margin-left: auto; margin-right: auto; width: 50px; height: 50px; padding: 2px; vertical-align: bottom;" src="data:image/png;base64,{{ @base64_encode(file_get_contents(public_path("/public/profil/appreciation1.png"))) }}">
            </p>
        </td>
        <td style="width: 20%;border-top-style: none;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['ae_color']}}">
                <img style="display: block; margin-left: auto; margin-right: auto; width: 50px; height: 50px; padding: 2px; vertical-align: bottom;" src="data:image/png;base64,{{ @base64_encode(file_get_contents(public_path("/public/profil/appreciation2.png"))) }}">
            </p>
        </td>
        <td style="width: 20%;border-top-style: none;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['me_color']}}">
                <img style="display: block; margin-left: auto; margin-right: auto; width: 50px; height: 50px; padding: 2px; vertical-align: bottom;" src="data:image/png;base64,{{ @base64_encode(file_get_contents(public_path("/public/profil/appreciation3.png"))) }}">
            </p>
        </td>
        <td style="width: 20%;border-top-style: none;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;">
            <p class="s10" style="font-size:10pt; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; color: #{{$legend_of_grade['abe_color']}}">
                <img style="display: block; margin-left: auto; margin-right: auto; width: 50px; height: 50px; padding: 2px; vertical-align: bottom;" src="data:image/png;base64,{{ @base64_encode(file_get_contents(public_path("/public/profil/appreciation4.png"))) }}">
            </p>
        </td>
    </tr>
</table>
...
{{--            </tr>--}}
            <tr>
                ...
                @php
                    $moyenneGeneraleSur4 = !is_null($moyenneGenerale)? ($moyenneGenerale * 4) / 20 : null;
                    $appreciationGenerale = getAppreciationStickerForMaternelle($moyenneGeneraleSur4, true);

                    $appreciationColorGenerale = getAppreciationGradeAndColor($moyenneGeneraleSur4, 4, true);
                @endphp

                <td class="" style="border: 1pt solid #212628; vertical-align: middle; text-align: center; color: #{{$legend_of_grade[$appreciationColorGenerale[1]]}};">
                    <b>{{ !is_null($moyenneGeneraleSur4)? round($moyenneGeneraleSur4, 2) : '-' }}<b/>
                </td>
                <td class="" style="border: 1pt solid #212628; vertical-align: middle; border-left:none; text-align: center">
                    APP.
                </td>
                <td style="border: 1pt solid #212628; border-left: none; vertical-align: middle; text-align: center">
                    <img style="text-align: center; width: 25px; height: 25px; padding: 2px" src="data:image/png;base64,{{ @base64_encode(file_get_contents(public_path("/public/profil/$appreciationGenerale"))) }}">
                </td>
            </tr>
        </table>
