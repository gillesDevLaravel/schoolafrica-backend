...
<img style="position: absolute; width: auto; height: 100%; background: transparent;" src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/public/profil/honour_roll_en.png")))); ?>" alt="Photo élève">
<?php else: ?>
<img style="position: absolute; width: auto; height: 100%; background: transparent;" src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("/public/profil/honour_roll_en.png")))); ?>" alt="Photo par défaut">
<?php endif; ?>
...
<div class="container">
    ...
    <p style="top:42.1%;left:15.7%;" class="ft15">
        Awarded by <b>"{{ strtoupper($ecole['nom']) }}"</b>
    </p>
    ...
    <p style="top:47.5%;left:26.6%;" class="ft15">Registration number: <?php echo e($matricule ?? 'XXXXXX'); ?></p>
    <p style="top:50.5%;left:26.6%;" class="ft116">Date of Birth: <b><?php echo e(\Carbon\Carbon::parse($birthday)->format('d F Y')); ?></b></p>
    <p style="top:53.5%;left:26.6%;" class="ft18">Sex: <b style="color:red;"><?php echo e(strtoupper($gender ?? 'F')); ?></b></p>
    <p style="top:56.5%;left:26.6%;" class="ft15">Enrolled in: <b><?php echo e($classe ?? 'Classe'); ?></b></p>


    <p style="top:47.2%;left:61.8%;" class="ft15">Average:</p>
    <p style="top:47.2%;left:67.9%;" class="ft19"><b style="color: #008000;"><?php echo e(round($moyenne, 2) ?? '00.00'); ?></b> / 20</p>
    <p style="top:49.7%;left:61.8%;" class="ft15">Appreciation:</p>
    <p style="position:absolute; top:49.7%; left:70.5%; width:120px; font-size:15px; font-family:Helvetica; color:#000000; white-space:normal; word-wrap:break-word;">
        <b style="color:#008000;"><?php echo e(strtoupper($appreciation) ?? '00.00'); ?></b>
    </p>

    <p style="top:60.8%;left:15.7%;" class="ft117">

        {{ $isBoy ? 'He' : 'She' }} has been distinguished by {{ $isBoy ? 'his' : 'her' }} work and {{ $isBoy ? 'his' : 'her' }} behaviour<br/>
        during <b>{{ $nom_trim }}</b> of the school year 2024/2025.
    </p>


    <p style="top:68.3%;left:15.7%;" class="ft112">Done in: <b>{{ mb_strtoupper($ecole['city']) . '-' . $ecole['adresse'] }}</b>, on: {{ date('d/m/Y') }}</p>
    <p style="top:68.3%;left:64.3%;" class="ft114"><i>DIRECTOR</i></p>
