...
<table id="listStudents" style="margin-top: 20px; width: 100%" cellspacing="0">
    <tr style="width: 100%;background-color: #0a92d6; color: white">
        ...
        <td
            ...
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt;font-size: 12px"><strong>{{ __('solvables.mmontant_percu') }}</strong></p>
        </td>
        <td
            style=" width:25pt; padding-left:5px; text-align: right">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt;font-size: 12px; padding-right: 2px;"><strong>{{ __('solvables.montant_restant') }}</strong></p>
        </td>
    </tr>
    ...
    @foreach($students as $key => $student)
        <tr @if($key % 2 == 0) style="background-color: rgba(246,243,243,0.82);" @endif>
            ...
            <td style="width: 10pt; ">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center;font-size: 11px;">{{ number_format($student['totalDejaPaye']) }} XAF</p>
            </td>
            <td style="width: 10pt; ">
                <p class="s2" style="padding-top: 4pt; text-indent: 0pt; text-align: center;font-size: 11px;">{{ number_format($student['montantRestant']) }} XAF</p>
            </td>
        </tr>
        @php $cpt++; @endphp
    @endforeach
