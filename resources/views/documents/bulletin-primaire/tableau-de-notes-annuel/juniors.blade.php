...
<table width="100%" style="border-collapse: collapse; margin-left: 0;">
    <tr style="background-color: #{{couleurEnteteTableauBulletinJunior()['bg']}};">
        <td rowspan="2" style="width: 50pt;border: 1pt solid #808080; ">
        ...
        <td rowspan="2" style="width: 90pt;border: 1pt solid #808080; ">
            <p class="s10" style="color: #{{couleurEnteteTableauBulletinJunior()['txt']}}; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; font-weight: bold">
                {{ strtoupper(__('bulletin_primaire.description')) }}
            </p>
        </td>
        <td rowspan="2" style=" width: 5pt;border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;" >
            <p class="s10" style="color: #{{couleurEnteteTableauBulletinJunior()['txt']}}; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center; font-weight: bold">
        ...
        <td colspan="3" style=" width: 5pt;border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;" >
            <p class="" style="color: #{{couleurEnteteTableauBulletinJunior()['txt']}}; text-align: center; font-weight: bold">
                {{ strtoupper(__('bulletin_primaire.trimester')) }}
            </p>
        </td>
        <td rowspan="2" style="border-right: none; width: 5pt;border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;" >
        ...
        <td rowspan="2" style="border-right: none; border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;" >
            <p class="s10" style="font-weight:bold; color: #{{couleurEnteteTableauBulletinJunior()['txt']}}; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center;">
                {!! strtoupper(__('bulletin_primaire.skill_synth')) !!}
            </p>
        </td>
        <td rowspan="2" style="border-top-style: solid;border-top-width: 1pt;border-top-color: #808080;border-left-style: solid;border-left-width: 1pt;border-left-color: #808080;border-bottom-style: solid;border-bottom-width: 1pt;border-bottom-color: #808080;border-right-style: solid;border-right-width: 1pt;border-right-color: #808080;" >
        ...
        @foreach($trimestres as $trimestre)
            ...
            <td class="td_border" style="width: 60%;" >
                <p class="s10" style="font-weight: bold; color: #{{couleurEnteteTableauBulletinJunior()['txt']}}; font-weight: bold; padding: 2pt; text-indent: 0pt; line-height: 10pt; text-align: center;">
                    {{ 'T' . strtoupper($trimestre['numbering']) }}
                </p>
            </td>
        @endforeach
    </tr>
                ...
                <td style="padding-left:0pt!important; width: 10pt;border: 1pt solid #808080">
                    ...
                    @foreach($matiere['typeEvaluations'] ?? [] as $key => $typeEvaluation)
                        @php
                            ...
                            $couleurTrimestre = getAppreciationGradeAndColor($typeEvaluation0['trimestres']["trimestre$idTrimestre"], $typeEvaluation0['noteMaxTrim']["noteMaxTrim$idTrimestre"]);
                        @endphp

                        @if($typeEvaluation0 !== null && isset($typeEvaluation0['trimestres']["trimestre$idTrimestre"]))

                            <p class="s14" style="font-weight:bold;  @if($key != end($cles))border-bottom: 1pt solid #808080;@endif text-align: center; color: #{{ $legend_of_grade[$couleurTrimestre[1]] }};">
                                {{ number_format_if_float($typeEvaluation0['trimestres']["trimestre$idTrimestre"], 1) }}
                            </p>
            ...
            @endforeach
                ...
                <td style="padding-left:0pt!important; width: 10pt;border: 1pt solid #808080">
                    @foreach($matiere['typeEvaluations'] ?? [] as $key => $typeEvaluation)
                        @php
                            $typeEvaluation0 = $matiere0['typesEvaluation'][$typeEvaluation['idTypeEval']] ?? null;
                            $couleurAnnuelle = getAppreciationGradeAndColor($typeEvaluation0["totalNoteObtenu"], $typeEvaluation0['noteMax']);
                        @endphp
                        <p class="s14" style="@if($key != end($cles))border-bottom: 1px solid #808080;@endif text-align: center; color: #{{ $legend_of_grade[$couleurAnnuelle[1]] }}; font-weight: bold;">
                ...
                <td style="vertical-align: middle;width: 25pt; padding-left: 5pt; padding-right: 5pt; border: 1pt solid #808080">
