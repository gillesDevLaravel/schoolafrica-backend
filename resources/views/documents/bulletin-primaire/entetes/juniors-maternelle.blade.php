...
<table width="90%" style="margin-left: 5%">
    <tr>
        <td style="text-align:center; background-color:green;font-size:15px;padding:5px; color:white;display:flex;" >{{ __('bul_mat.bul_notes') }}</td>
        <td style="text-align:center; background-color:red;font-size:15px;padding:5px; color:white;">{{ __('bul_mat.ensgn_franc') . " " . $infosEvaluation['name'] }}</td>
        <td style="text-align:center; background-color:rgb(239, 239, 49);font-size:15px;padding:5px; color:rgb(14, 14, 14);">{{ $annee_scolaire }}</td>
    </tr>
</table>
