<table style="width: 100%;">
    @php
        if(str_contains($route, "kingdom")){
            //Pour kingdom
            $regionFr = "du Centre";
            $regionEn = "Center";

            $departementFr = "de Méfou-et-Akono";
            $departementEn = "Méfou-et-Akono";
        }
        else{
            $regionFr = "du Centre";
            $regionEn = "Center";

            $departementFr = "du Mfoundi";
            $departementEn = "Mfoundi";
        }
    @endphp
    <tr>
