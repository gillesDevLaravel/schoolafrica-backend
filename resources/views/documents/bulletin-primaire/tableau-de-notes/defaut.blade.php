                        ...
                        <td style="padding-left:0pt!important; width: 10pt;border: 1pt solid #808080">
                            ...
                            @foreach($matiere['typeEvaluations'] ?? [] as $key => $typeEvaluation)
                                ...
                                @if($typeEvaluation0 !== null && isset($typeEvaluation0['sequences']["sequence$idSequence"]))
                                    ...
                                    <p class="s14" style="font-weight:bold;  @if($key != end($cles))border-bottom: 1pt solid #808080;@endif text-align: center; @if($typeEvaluation0['sequences']["sequence$idSequence"] < $typeEvaluation0['noteMax']/2) color: red @endif">
                                        {{ number_format_if_float($typeEvaluation0['sequences']["sequence$idSequence"], 2) }}
                                    </p>
