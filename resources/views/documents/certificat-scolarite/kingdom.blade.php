...
<div class="content-wrapper">
    ...
    <table class="header-table" style="width:100%; border-collapse: collapse; margin-bottom: 20px; font-size:12px; line-height:1.2;">
     ...
     <!-- NOM ÉCOLE -->
     <br>
    <div class="school-name">KINGDOM LIFE ACADEMY</div>
    <div class="contact-line">Motto: The Kingdom of God is in Power</div>
    <br>
    <!-- Titre du certificat -->
    <div style="text-align:center; font-size:25px; margin-bottom:30px;">
        ...
        <p style="text-align:center; font-size:14px;">
            The head mistress of “<strong>KINGDOM</strong>” certify that<br>
            Le directeur de “<strong>KINGDOM</strong>” certifie que :
        </p>
      <br>
    ...
    <div style="padding:10px 30px; font-size:18px;">
        ...
        <br/><br/>
        <strong>The Head Teacher/ Le Directeur</strong>
      </div>
