...
<table style="text-align: center;  width: 100%; background-color: #0a92d6">
    <tr>
        <td style="text-align: center; font-size:20px; color: white">
            <strong>{{ __('document_list_pension_users.list_fee_title') }}</strong>
        </td>
    </tr>
</table>
...
<table id="listStudents" style="margin-top: 20px; width: 100%" cellspacing="0">
    <tr style="width: 100%;background-color: #0a92d6; color: white">
        ...
        <td
            style="width: 175pt; padding-left: 5px; ">
            <p class="s2" style="padding-top: 4pt; padding-right: 2pt; text-indent: 0pt; text-align: left;font-size: 12px"><strong>{{ __('document_list_pension_users.eleve') }}</strong></p>
        </td>
        <td
            style=" width:50pt; padding-left:5px;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt;font-size: 12px"><strong>{{ __('document_list_pension_users.fees') }}</strong></p>
        </td>
        <td
            style=" width:25pt; padding-left:5px; text-align: right">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt;font-size: 12px; padding-right: 2px;"><strong>{{ __('document_list_pension_users.amount') }}</strong></p>
        </td>
        <td
            style="width:20pt; padding-left:5px; text-align: center">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt;font-size: 12px"><strong>Mode</strong></p>
        </td>
        <td
            style=" width:40pt; padding-left:5px;">
            <p class="s2" style="padding-top: 4pt; text-indent: 0pt;font-size: 12px"><strong>Date</strong></p>
        </td>
    </tr>
    ...
    @foreach($fees as $key => $fee)
        <tr @if($key % 2 == 0) style="background-color: rgba(246,243,243,0.82);" @endif>
            ...
            <td style="width: 155pt; padding-left: 5px; ">
                <p class="s2" style="padding-top: 4pt; padding-right: 2pt; text-indent: 0pt;font-size: 12px;">{{ $fee->user_name }}</p>
            </td>
            <td
                style=" width: 70pt; ">
                <p class="s2" style="padding-top: 4pt; padding-bottom: 4pt; text-indent: 0pt; padding-left: 2px; font-size: 12px;">{{ $fee->fee_name }}</p>
            </td>
            <td
                style=" width: 25pt; text-align: right">
                <p class="s2" style="padding-top: 4pt; padding-bottom: 4pt; text-indent: 0pt; padding-right: 2px; font-size: 12px;">{{ number_format($fee->advancePayment) }}</p>
            </td>
            <td
                style=" width: 60pt; text-align: center">
                <p class="s2" style="padding-top: 4pt; padding-bottom: 4pt; text-indent: 0pt; padding-left: 2px; font-size: 12px;">{{ $fee->payment_mode }}</p>
            </td>
            <td
                style=" width: 30pt; ">
                <p class="s2" style="padding-top: 4pt; padding-bottom: 4pt; text-indent: 0pt; padding-left: 2px; font-size: 12px;">{{ $fee->date }}</p>
            </td>
        </tr>
        @php $cpt++; @endphp
    @endforeach
