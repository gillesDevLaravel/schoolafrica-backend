...
<head>
    <meta charset="UTF-8">
    <title>Votre mot de passe a été changé !</title>
    <style>
        body {
...
<div class="container">
    <h1>Votre mot de passe a été changé par {{ $author->name }} !</h1>

    <p>Cher(e) utilisateur(trice),</p>

    <p>Votre mot de passe a été changé par <strong>{{ $author->name }}</strong>! Vous trouverez ci-dessous vos nouveaux identifiants de connexion :</p>
    <ul>
