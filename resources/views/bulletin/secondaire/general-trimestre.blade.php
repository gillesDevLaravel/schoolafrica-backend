...
<head>
    ...
    <title>Bulletin Secondaire trimestre - {{ $user->name }}</title>
    <style type="text/css">
        body {
            padding: 5px 30px;
            font-size: 11px;
...
<table style="text-align: center;  width: 100%; margin: 1pt 0">
    <tr>
        <td style="text-align: center; font-size: 12pt"><strong>BULLETIN SCOLAIRE TRIMESTRE </strong></td>
                ...
                <tr>
                    <td colspan="2" style="border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                        <p class="s2" style="padding-top: 4pt; margin-left: 2pt; text-align: left;">
                            Date et Lieu de Naissance: <strong>{{ $user->birthday }}</strong> à <strong>{{ $user->placeofbirth }}</strong>
...
@if(file_exists(public_path("/public/profil/filigranne.jpeg")))
    <div
        ...
        background-repeat: no-repeat; background-position: center; background-size: cover; z-index: -1; opacity: 0.25; background-size: 70%;">
@else
    <div>
@endif
    <table style="border-collapse: collapse; margin-top: 15px;  width: 100%" cellspacing="0">
        <tr>
            <td style="width:100pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>GROUPES DE MATIERES</strong></p>
            </td>
            ...
            <td style="width: 50pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>Appréciations <br> et Visa de l'enseignant</strong></p>
            </td>
        </tr>
        ...
        @foreach($user->trimestre[0]->assessmentType[0]->matterGroup as $matterGroup)
            <tr>
{{--            <tr style="">--}}
                <td rowspan="{{ count($matterGroup->assessment) }}" style="page-break-inside: avoid !important; vertical-align: middle; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                    <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>{{ $matterGroup->name }}</strong></p>
                </td>
                <td style="border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                    <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>{{ $matterGroup->assessment[0]->nameMatter }}</strong></p>
                </td>
                <td style="width: 25pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                    <p class="s2" style="padding-top: 4pt; text-align: center;">{{ @$matterGroup->assessment[0]->ratings->value }}</p>
                </td>
                <td rowspan="{{ count($matterGroup->assessment) }}" style="vertical-align: middle; width: 25pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                ...
                <td rowspan="{{ count($matterGroup->assessment) }}" style="vertical-align: middle; width: 40pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                    <p class="s2" style="padding-top: 4pt; text-align: center;">[0 - 19[</p>
                </td>
                <td rowspan="{{ count($matterGroup->assessment) }}" style="vertical-align: middle; width: 50pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                    <p class="s2" style="padding-top: 4pt; text-align: center;"></p>
                </td>
            </tr>

            @foreach($matterGroup->assessment as $k => $assessment)
                @php if($k==0) continue; @endphp

                <tr style="page-break-inside: avoid !important;">
                    <td style="border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                        <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>{{ $assessment->nameMatter }}</strong></p>
                    </td>
                    <td style="width: 25pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1.5pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                        <p class="s2" style="padding-top: 4pt; text-align: center;">{{ @$assessment->ratings->value }}</p>
                    </td>
                </tr>
            @endforeach
        @endforeach
    ...
    <table style="margin-top: 18pt; border-collapse: collapse; width: 100%" cellspacing="0">
        ...
        <tr>
            ...
            <td style="border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                <p class="s3" style="padding-top: 3pt; text-align: left; margin-left: 2pt;">MOYENNE SEQ.</p>
            </td>
            <td style="width: 25pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
