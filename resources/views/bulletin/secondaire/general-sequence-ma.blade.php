    ...
    >
        <table style="border-collapse: collapse; margin-top: 15px;  width: 100%" cellspacing="0">
            <tr style="justify-content: center; align-items: center">
                <td style="width:100pt; border: 1pt solid #212628">
                    <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>{{ __('bulletin_secondaire.matter_group') }}</strong></p>
                </td>
                <td style="width:150pt; border: 1pt solid #212628; height: 30px;">
                    <div style="display: flex; flex-direction: row; width: 100%; height: 30px;">
                        <div style="float: left; width: 50%; height: 30px;  text-align: center;">TEST</div>
                        <div style="float: right; border-left: 1pt solid #212628; width: 50%; height: 30px;  text-align: center;">TEST 2</div>
                    </div>
{{--                    <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>{{ __('bulletin_secondaire.comp_eval') }}</strong></p>--}}
                </td>
{{--                <td style="width: 25pt; border: 1pt solid #212628; text-align: center; vertical-align: middle">--}}
{{--                    <span style="">N/20</span>--}}
{{--                    <p class="" style="padding-top: 4pt; text-align: center;"><strong>N/20</strong></p>--}}
{{--                </td>--}}
{{--                <td style="width: 25pt; border: 1pt solid #212628; text-align: center; vertical-align: middle">--}}
{{--                    M/20--}}
...
{{--                </td>--}}
{{--                <td style="width: 40pt; border: 1pt solid #212628; text-align: center; vertical-align: middle">--}}
{{--                    [Min - Max]--}}
{{--                    <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>[Min - Max]</strong></p>--}}
{{--                </td>--}}
{{--                <td style="width: 50pt; border: 1pt solid #212628">--}}
{{--                    <span>{!! __('bulletin_secondaire.app_and_teacher_visa') !!}</span>--}}
...
{{--                </td>--}}
            ...
            @foreach($user->trimestre[0]->assessmentType[0]->matterGroup as $matterGroup)
                <tr style="">
                    <td style="min-height:150px; page-break-inside: avoid !important; vertical-align: middle; border: 1pt solid #212628">
...
{{--                    </td>--}}
                    <td style="width:150pt; border: 1pt solid #212628;">
                        @foreach($matterGroup->assessment as $key => $assessment)
                        <p>
                            <div style="display: flex; flex-direction: column; width: 100%; border-bottom: 1pt solid red">
                                <div style="float: left; width: 50%; height: 30px;  text-align: center;">testee</div>
                                <div style="float: right; border-left: 1pt solid #212628; width: 50%; height: 30px;  text-align: center;">0</div>
                            </div>
                        </p>
                        @endforeach
                        {{--                    <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>{{ __('bulletin_secondaire.comp_eval') }}</strong></p>--}}
...
{{--                        <span style="color: white">{{$assessment->ratings->value}}</span>--}}
