...
<table style="text-align: center;  width: 100%; margin: 1pt 0">
    <tr>
        <td style="text-align: center; font-size: 12pt"><strong>{{ __('bulletin_secondaire.bul_sec_trim') }} </strong></td>
    ...
    <tr>
        ...
        <td style="width: 85%;">
            <table style="border-collapse: collapse;width: 100%" cellspacing="0">
                <tr>
                    <td colspan="3" style="border: 1pt solid #212628">
                ...
                <tr>
                    <td style="width: 185pt; border: 1pt solid #212628">
                    ...
                    <td rowspan="2" style="border: 1pt solid #212628">
                ...
                <tr>
                    <td colspan="3" style="height: 50px; border: 1pt solid #212628">
                        <p class="s2" style="padding-top: 4pt; margin-left: 2pt; text-align: left;">
...
>
    <table style="border-collapse: collapse; margin-top: 15px;  width: 100%" cellspacing="0">
        <tr style="vertical-align: middle">
            ...
            <td style="width: 40pt; border: 1pt solid #212628">
                <p class="s2" style="padding-top: 4pt; text-align: center;"><strong>[Min - Max]</strong></p>
            </td>
            <td style="width: 50pt; border: 1pt solid #212628">
        ...
        @foreach($user->trimestre[0]->assessmentType[0]->matterGroup as $matterGroup)
            <tr style="">
                <td style="page-break-inside: avoid !important; vertical-align: middle; border: 1pt solid #212628; text-align: left; padding: 2pt; padding-left: 4pt;">
                    <p class="s2" style="padding-top: 4pt; text-align: left;">{{ $matterGroup->name }}</p>
                    <br>
                    M/Mme {{ @$matterGroup->assessment[0]->tearcherName }}
                </td>
                <td style="height:{{40*count($matterGroup->assessment)}}px; vertical-align: middle; border: 1pt solid #212628;">
                    @foreach($matterGroup->assessment as $key => $assessment)
                        @if($key != count($matterGroup->assessment)-1)
                            <p class="s14" style="padding: 1pt; justify-content: center; height: 40px; text-align: center; border-bottom: 1px solid black; ">
                                {{ $assessment->nameMatter ?? "-" }}
                            </p>
                        @endif
                    @endforeach
                    <p class="s14" style="padding:1pt; height: 40px; text-align: center; text-indent: 0pt; vertical-align: middle">
                        {{ $assessment->nameMatter ?? "-" }}
                    </p>
                </td>
                <td style="{{40*count($matterGroup->assessment)}}px; width: 25pt; border: 1pt solid #212628">
                    @foreach($matterGroup->assessment as $key => $assessment)
                        @if($key != count($matterGroup->assessment)-1)
                            <p class="s14" style="height: 40px;padding: 1pt; text-align: center; border-bottom: 1px solid black; ">
                                <strong style="vertical-align: middle">{{ $assessment->ratings->value ?? "-" }}</strong>
                            </p>
                        @endif
                    @endforeach
                    <p class="s14" style="height: 40px;padding: 1pt; text-align: center; text-indent: 0pt;"><strong>{{ $assessment->ratings->value ?? "-" }}</strong></p>
                </td>
                <td style="vertical-align: middle; width: 25pt; border: 1pt solid #212628">
                ...
                <td style="vertical-align: middle; width: 40pt; border: 1pt solid #212628">
                    @php
                ...
                <td style="vertical-align: middle; width: 50pt; border: 1pt solid #212628">
    ...
    <table style="margin-top: 18pt; border-collapse: collapse; width: 100%" cellspacing="0">
        ...
        <tr>
            ...
            <td style="border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
                <p class="s3" style="padding-top: 3pt; text-align: left; margin-left: 2pt;">{{ __('bulletin_secondaire.moy_trim') }}</p>
            </td>
            <td style="width: 25pt; border-top-style: solid; border-top-width: 1pt; border-top-color: #212628; border-left-style: solid; border-left-width: 1pt; border-left-color: #212628; border-bottom-style: solid; border-bottom-width: 1pt; border-bottom-color: #212628; border-right-style: solid; border-right-width: 1pt; border-right-color: #212628;">
